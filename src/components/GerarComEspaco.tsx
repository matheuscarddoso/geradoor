  ...
  return (
    ...
    >
      <span className="apenas-mouse">
        ...
        {ingles ? "for another" : "para gerar outro"}
      </span>
      <span className="apenas-toque">{ingles ? "Tap for another" : "Toque para gerar outro"}</span>
    </button>
  );
}
